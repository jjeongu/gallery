...
function check() {
	const f = document.Fan_BoardForm;
	let str;
    ...
    f.action = "${pageContext.request.contextPath}/fan_board/${mode}";
    return true;
}
...
function deleteFile(num) {
	...
	let url = "${pageContext.request.contextPath}/fan_board/deleteFile?num=" + num ;
	location.href = url;
}
</c:if>
</script>
					...
					<table class="table table-borderless">
	 					<tr>
							<td class="text-center">
								...
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/fan_board/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i class="bi bi-x"></i></button>
