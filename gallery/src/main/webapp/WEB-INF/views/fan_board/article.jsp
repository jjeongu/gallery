			...
			<div class="body-main">
							...
							<td colspan="2">
								<c:if test="${not empty dto.saveFilename}">
									<p class="border text-secondary mb-1 p-2">
										...
										<a href="${pageContext.request.contextPath}/fan_board/download?num=${dto.num}">${dto.uploadfilename}</a>
										[${dto.fileSize} byte]
									</p>
								</c:if>
							</td>
						...
						<tr>
							<td colspan="2">
								...
								<c:if test="${not empty prevDto}">
									<a href="${pageContext.request.contextPath}/fan_board/article?${query}&num=${prevDto.num}">${prevDto.subject}</a>
								</c:if>
							</td>
						</tr>
						<tr>
							<td colspan="2">
								...
								<c:if test="${not empty nextDto}">
									<a href="${pageContext.request.contextPath}/fan_board/article?${query}&num=${nextDto.num}">${nextDto.subject}</a>
								</c:if>
							</td>
						</tr>
					</tbody>
				...
				<table class="table table-borderless">
					<tr>
						...
						<td class="text-end">
							<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/fan_board/list?${query}';">리스트</button>
						</td>
					</tr>
				</table>
			
			
				<!-- 댓글 작성 양식과 댓글 목록을 표시하는 구조 -->
				<div class="reply">
...
//게시글 공감 여부
$(function(){
	$(".btnSendFan_BoardLike").click(function(){
		const $i = $(this).find("i");
		...
		let url = "${pageContext.request.contextPath}/fan_board/insertFan_BoardLike";
		let num = "${dto.num}";
...
function listPage(page) {
	let url = "${pageContext.request.contextPath}/fan_board/listReply";
...
$(function(){
	$(".btnSendReply").click(function(){
		...
		let url = "${pageContext.request.contextPath}/fan_board/insertReply";
...
$(function(){
	$("body").on("click", ".deleteReply", function(){
		...
		let url = "${pageContext.request.contextPath}/fan_board/deleteReply";
...
function listReplyAnswer(answer) {
	let url = "${pageContext.request.contextPath}/fan_board/listReplyAnswer";
...
function countReplyAnswer(answer) {
	let url = "${pageContext.request.contextPath}/fan_board/countReplyAnswer";
	let query = "answer=" + answer;
...
$(function() {
	$(".reply").on("click", ".btnSendReplyLike", function() {
		...
		let url = "${pageContext.request.contextPath}/fan_board/insertReplyLike";
